...
class LYRAGAME_API ALyraCharacter : public AModularCharacter, public IAbilitySystemInterface/*技能, GAS*/, public IGameplayCueInterface/*特效*/, public IGameplayTagAssetInterface/*Tag*/, public ILyraTeamAgentInterface
{
	GENERATED_BODY()
